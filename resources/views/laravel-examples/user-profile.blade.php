                ...
                <div class="col-auto my-auto">
                    <div class="h-100">
                        ...
                        <p class="mb-0 font-weight-bold text-sm">
                            {{ auth()->user()->role }} {{ auth()->user()->section }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body pt-4 p-3">
                <form action="/user-profile" method="POST" role="form text-left">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('email')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ auth()->user()->email }}" type="email" placeholder="example@mail.com" id="user-email" name="email">
                                        @error('email')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.phone')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Departement" name="departement" value="{{ auth()->user()->departement }}">
                                        @error('departement')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-control-label">{{ __('Section') }}</label>
                                <div class="@error('user.location') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Section" name="section" value="{{ auth()->user()->section }}">
                                </div>
                            </div>
                        </div>
                    </div>
